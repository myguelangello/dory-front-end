...
export function Home() {
  ...
  const interesses = user?.interests;
  ...
  const listTCCs = [
    {
      id: 0,
      title:
        'Desenvolvimento de uma personagem para um projeto de jogo digital de terror utilizando a abordagem The Silver Way',
      aluno: 'Douglas Alves da Silva',
      professor: 'Liandro Roger',
      areas: ['Design de personagens', 'Cartum', 'Jogos de Terror'],
    },
    {
      id: 1,
      title:
        'Análise de metodologias ágeis como recursos para desenvolvimento de jogos digitais de pequeno escopo',
      aluno: 'Henrique Artur Cordeiro Gomes',
      professor: 'Henrique Barbosa Silva',
      areas: ['Metodologias ágeis', 'Jogos', 'Scrum'],
    },
  ];
          ...
          {interesses ? (
            interesses?.map((inter, index) => (
              <div key={index} className="item-resultado">
                ...
                <MenuTCCs status={TCCs} TCCs={listTCCs} />
              </div>
            ))
          ) : (
