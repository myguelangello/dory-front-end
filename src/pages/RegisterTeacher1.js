      ...
      <section className="container" id="register-student">
        <form onSubmit={() => {}}>
            ...
            <div className="div-inputs">
              ...
              <div className="label-required question-checkbox">
                <label htmlFor="perfil">
                  Nesse semestre, você está disponível para orientar?
                </label>
                <label id="required">*</label>
              </div>
              <div className="list-checkbox">
                <RadioButton name="disponivel" question="Disponível" />
                <RadioButton name="indisponivel" question="Indisponível" />
                <RadioButton
                  name="em-analise"
              ...
              <div className="label-required question-checkbox">
                <label htmlFor="perfil">
                  Qual a modalidade de TCC você escolheu?
                </label>
                <label id="required">*</label>
              </div>
              <div className="list-checkbox">
                ...
                />
                <Checkbox name="monografia" question="Monografia" />
                <Checkbox
          ...
          <div className="div-buttons">
            <button className="default">Cancelar</button>
